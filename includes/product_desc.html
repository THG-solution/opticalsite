    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div>
                <div class="pd-product-list-title">
                    <h2>Customer Reviews ( <span id="pd-reviewNo"> 200 </span> )</h2>
                </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="pd-spec-details">
                ...
                <ul class="py-4">
                    <li class="pb-2"> Size: 52-18-148</li>
                    <li class="pb-2"> Total Width: 140 mm</li>
                    <li class="pb-2"> Lens Diagonal Size: 52 mm</li>
                    <li class="pb-2"> Weight: 15 g</li>
                    <li class="pb-2"> Bifocal/Progressive: Yes</li>
                    <li class="pb-2"> Spring Hinge: No</li>
                    <li class="pb-2"> Material: Tr</li>
                </ul>  
            </div>
