...
$resultSet = $product->queryData("SELECT c.image, p.product_id, p.avg_star, p.total_review, p.price FROM products p, product_colors c WHERE c.product_id = p.product_id");
    ...
    <div class='product-list-item'>
        ...
        <ul class='product-variation d-flex justify-content-center'>
            <li class='product-variation-list'>
                <span style='background-size:100% 100%;background:linear-gradient(#000,#9a7a3f)'
                    class='product-variation-list-item '></span>
            </li>
            <li class='product-variation-list'>
                <span style='background-size:100% 100%;background:linear-gradient(#000,#9a7a3f)'
                    class='product-variation-list-item '></span>
